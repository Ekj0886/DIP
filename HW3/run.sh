make
echo "<\nTask 1>" 
./HW3 --WBalance 5 input/input1.bmp output/output1_1.bmp
./HW3 --WBalance 10 input/input2.bmp output/output2_1.bmp
./HW3 --WBalance 5 input/input3.bmp output/output3_1.bmp
./HW3 --WBalance 2 input/input4.bmp output/output4_1.bmp
echo "\n<Task 2>" 
./HW3 --lumin 0.7 --Saturate 1.5 -s 0.5 output/output1_1.bmp output/output1_2.bmp
./HW3 --lumin 0.7 --Saturate 2.0 -s 0.2 output/output2_1.bmp output/output2_2.bmp
